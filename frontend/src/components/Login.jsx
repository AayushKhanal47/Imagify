...
const Login = () => {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/40 flex justify-center items-center">
      <form className="relative bg-white p-10 rounded-2xl shadow-2xl w-full max-w-md text-slate-600 space-y-6">
        ...
        <button className="bg-blue-600 w-full text-white py-3 rounded-xl font-medium hover:bg-blue-700 transition">
